...
public class HistoryItemDetailsTab extends JFrame{
	private SalesSystemModel model; 
	private HistoryItem HItem;
	private JButton OKButton;
	public HistoryItemDetailsTab(SalesSystemModel model,HistoryItem HItem) {
		this.model=model;
		this.HItem=HItem;
		setSize(300, 500);
    ...
    private Component drawHistoryDetailMainPane() {
      ...
      final JTable table = new JTable(model.getHistoryItemDetailsTabModel());
